      ...
      <v-col cols="3">
        ...
        >
          <v-list-item two-line class="bg-dark">
            <v-list-item-content>
              <v-list-item-title class="white--text card-title">{{ $t('label.rdt_receipt_title') }}</v-list-item-title>
              <v-list-item-title class="headline mb-1 white--text summary-value">{{ recipientFaskesSummary.quantity_distributed | currency }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
        ...
        >
          <v-list-item two-line class="bg-success">
            <v-list-item-content>
              ...
              <v-list-item-title class="headline mb-1 white--text summary-value">{{ recipientFaskesSummary.quantity_available | currency }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
        ...
        >
          <v-list-item two-line class="bg-info">
            <v-list-item-content>
              ...
              <v-list-item-title class="headline mb-1 white--text summary-value">{{ recipientFaskesSummary.quantity_used | currency }}</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-card>
      </v-col>
